...
一直想做一款小区物业管理系统，看了很多优秀的开源项目但是发现没有合适的。于是利用空闲休息时间开始自己写了一套管理系统。
学习过程中遇到问题可以咨询微信：lengqin1024 或者发Email: kefu308@gmail.com

## 在线体验


- 代码下载：https://github.com/geeeeeeeek/python_wuye
- 演示地址：http://wuye.gitapp.cn/
...
- 业主管理：管理系统可以录入、修改和查询业主的基本信息，如业主名称、价格、备注等。
- 小区管理：小区信息的增删改查。
- 报修管理：报修信息的增删改查。
- 停车管理：停车信息的增删改查。
- 资产管理：资产信息的增删改查。
...
在业主管理系统中，需要存储和管理业主信息、评论信息、分类信息、标签信息、用户信息、通知信息、日志信息。
...
无论是业主管理、用户管理、小区管理、报修管理、日志管理等功能都是基于springboot+vue框架开发的，开发流程是：
...
下面用业主管理功能来演绎这个流程，其它的管理功能都是这个流程。
        ...
        <div style="padding-right: 16px; max-height: 480px; overflow-x: hidden; overflow-y: auto">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="12">
                <a-form-item label="小区名称" name="classification">
                  <a-select
                    placeholder="请选择"
                    allowClear
                    :options="modal.cData"
              ...
              <a-col span="12">
                <a-form-item label="住址" name="address">
                  <a-input placeholder="请输入" v-model:value="modal.form.address" />
                </a-form-item>
              </a-col>
              <a-col span="12">
              ...
              <a-col span="12">
                <a-form-item label="状态" name="status">
                  <a-select placeholder="请选择" allowClear v-model:value="modal.form.status">
                    <a-select-option key="0" value="0">在住</a-select-option>
                    <a-select-option key="1" value="1">搬走</a-select-option>
                  </a-select>
                </a-form-item>
              </a-col>
            </a-row>
...
<script setup lang="ts">
  ...
  const columns = reactive([
    ...
    },
    {
      ...
      dataIndex: 'status',
      key: 'status',
      customRender: ({ text, record, index, column }) => (text === '0' ? '在住' : '已搬走'),
    },
    {
      title: '备注',
      dataIndex: 'remark',
...
这就是业主管理功能的实现流程，其它的功能管理实现一模一样的。按照这个流程编写即可。
