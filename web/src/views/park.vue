      ...
      >
        ...
        <div style="padding-right: 16px; max-height: 480px; overflow-x: hidden; overflow-y: auto">
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              <a-col span="12">
                <a-form-item label="业主姓名" name="title">
              ...
              <a-col span="12">
                <a-form-item label="车位号" name="park_number">
                  <a-input placeholder="请输入" v-model:value="modal.form.park_number" />
                </a-form-item>
              </a-col>
              <a-col span="12">
                <a-form-item label="车牌号" name="car_number">
                  <a-input placeholder="请输入" v-model:value="modal.form.car_number" />
                </a-form-item>
              </a-col>
            </a-row>
          </a-form>
...
<script setup lang="ts">
  ...
  import { createApi, listApi, updateApi, deleteApi } from '/@/api/park';
  ...
  const handleOk = () => {
    myform.value
      ...
      .then(() => {
        ...
        formData.append('car_number', modal.form.car_number || '');
