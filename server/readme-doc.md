...
> 基于django+mysql开发的小区物业管理系统，本文档包括功能说明、数据库设计、开发过程。学习过程遇到问题可以咨询作者：lengqin1024（微信）

## 功能说明

- 业主管理（包括业主的新增、查询、删除、编辑功能）
- 小区管理（包括小区的新增、查询、删除、编辑功能）
- 报修管理（包括设备维修的新增、查询、删除、编辑、备注功能）
- 停车管理（包括停车位的新增、查询、删除、编辑、绑定车牌、绑定业主功能）
...
无论是用户管理、小区管理、业主管理等功能都是基于django的restframework框架开发的，开发流程是：
- 第一步：编写model模型
- 第二步：编写序列化器
- 第三步：编写view视图
- 第四步：配置url接口地址
